...
void ConfigurePPS(void)
{
    ...
    /*UART1*/
    PPSInput(IN_FN_PPS_U1RX,IN_PIN_PPS_RPI45);          // Assign UART1 Receive (U1RX) to RPI46 pin
    PPSOutput(OUT_FN_PPS_U1TX,OUT_PIN_PPS_RP41);        // Assign UART1 Transmit (U1TX) to RP36 pin

    /*ECAN1*/
    PPSInput(IN_FN_PPS_C1RX,IN_PIN_PPS_RPI46);          // Assign ECAN1 Receive (C1RX) to RPI47 pin
